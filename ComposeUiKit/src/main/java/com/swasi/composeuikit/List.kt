...
import com.swasi.composeuikit.theme.dp_15
import com.swasi.composeuikit.theme.dp_3
import com.swasi.composeuikit.theme.dp_50
import com.swasi.composeuikit.theme.sp_16
...
fun ExpandableCard(item: Country) {
    ...
    Card(
        ...
        Column(
            ...
            if (expandedState.value) {
                Text(
                    text = "Additional info for ${item.name}"
                )
            }
        }
    }
